...
import {appendParams, blobUrlFromScript, scriptUrl, setFragment} from '../../src/builders/script_url_builders';
...
describe('script_url_builders', () => {
  ...
  describe('setFragment', () => {
    it('appends when there is no existing fragment', () => {
      expect(setFragment(scriptUrl`https://google.com/`, 'def').toString())
          .toBe('https://google.com/#def');
    });

    it('overwrites an existing fragment', () => {
      expect(setFragment(scriptUrl`https://google.com/#abc`, 'def').toString())
          .toBe('https://google.com/#def');
    });
  });
